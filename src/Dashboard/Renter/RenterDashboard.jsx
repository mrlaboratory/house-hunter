    ...
    return (
        ...
        <div className="drawer-side ">
            ...
            <ul className="menu p-4 w-80 h-full bg-gray-200  dd ">
                ...
                <NavLink className='btn flex justify-start rounded-lg shadow-md border bg-white my-1 text-gray-600 ' to='/dashboard/mybookings'> <BsFillHousesFill className='text-xl'></BsFillHousesFill>My Bookings</NavLink>
